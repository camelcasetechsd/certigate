        ...
        concat: {
            ...
            js: {
                ...
                src: [
                    ...
                    '<%= dirs.jsSrc %>/datepicker/jquery.calendars.picker.js',
                    '<%= dirs.jsSrc %>/datepicker/jquery.calendars.picker.lang.js',
                    '<%= dirs.jsSrc %>/datepicker/jquery.calendars.picker-ar.js',
                    '<%= dirs.jsSrc %>/datepicker/jquery.calendars.islamic.js',
                    '<%= dirs.jsSrc %>/datepicker/jquery.calendars.islamic-ar.js',
