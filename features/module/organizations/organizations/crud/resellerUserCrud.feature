...
@javascript
Scenario: create organization Reseller as Reseller user
    ...
    And I fill in "commercialName" with "reseller test 1"
    And I fill in "commercialNameAr" with "reseller test 1 arabic"
    And I fill in "ownerName" with "reseller owner 1"
    And I fill in "ownerNameAr" with "reseller owner 1 in arabic"
    ...
    Then I should find organization with name "reseller test 1" type "Re-Seller" and expiration "NO Expiration Date"
    
    #Making sure that data is saved right
    When I perform "More" action on row with "reseller test 1" value
    Then I should see "reseller test 1"
    Then I should see "reseller test 1 arabic"
    Then I should see "reseller owner 1"
    Then I should see "reseller owner 1 in arabic"
...
Scenario: Testing Organization Edit
    ...
    Given I mock the login session as "reseller"
    And I go to "/organizations/myorganizations"
    When I perform "Edit" action on row with "reseller test 1" value
