...
class Statement {
    ...
    public function __construct() {
        foreach($this->statements as $statementKey => $statementArray){
            $title = $statementArray[self::STATEMENT_TITLE];
            $this->statements[$statementKey][self::STATEMENT_SENTENCE] = sprintf(self::STATEMENT_SENTENCE_PLACEHOLDER, $title);
        }
    }
}
